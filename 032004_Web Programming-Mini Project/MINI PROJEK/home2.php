    ...
    <div id="main"><div id="main2">
            <div id="content">
                <div class="post">
                    ...
                    <P><a style="color:blue" href="home1.php" rel="index up up up">LAMAN UTAMA</a> >
  MAKLUMAT PELAJAR</P>
                    <div class="entry">
                      <p>
                        <?php
                      ...
                      <form action="updatestudent.php" method="post" >
                        ...
                        <table width="510" height="192" border="0" class='easy_share' >
                          ...
                          <tr>
                            ...
                            <td><input type="text" name="alamat" value="<?php echo"".$row['alamat'].""; ?> " readonly="readonly"   /></td>
                          </tr>
                          <tr>
                            <td><font color="black">NO TELEFON:</font></td>
                            <td><input name="notelefon"  maxlength="30" value="<?php echo"".$row['notelefon'].""; ?>" readonly="readonly"  /></td>
                          </tr>
                          <tr>
                            <td><font color="black">EMAIL:</font></td>
                            <td><input name="email"  maxlength="30" value="<?php echo"".$row['email'].""; ?>" readonly="readonly"  /></td>
                          </tr>
                           <tr>
